...
//import com.example.spring.netty.spring_netty.server.postgres.common.annotations.VisibleForTesting;
import ru.sber.df.epmp.netty_postgres.server.postgres.exceptions.RelationUnknown;
import ru.sber.df.epmp.netty_postgres.server.postgres.exceptions.SchemaUnknownException;
//import com.example.spring.netty.spring_netty.server.postgres.expression.udf.UserDefinedFunctionMetadata;
//import com.example.spring.netty.spring_netty.server.postgres.expression.udf.UserDefinedFunctionsMetadata;
import ru.sber.df.epmp.netty_postgres.server.postgres.metadata.blob.BlobSchemaInfo;
//import com.example.spring.netty.spring_netty.server.postgres.metadata.doc.DocSchemaInfoFactory;
import ru.sber.df.epmp.netty_postgres.server.postgres.metadata.information.InformationSchemaInfo;
import ru.sber.df.epmp.netty_postgres.server.postgres.metadata.pgcatalog.PgCatalogSchemaInfo;
import ru.sber.df.epmp.netty_postgres.server.postgres.metadata.sys.SysSchemaInfo;
...
//import com.example.spring.netty.spring_netty.server.postgres.metadata.view.View;
//import com.example.spring.netty.spring_netty.server.postgres.metadata.view.ViewMetadata;
//import com.example.spring.netty.spring_netty.server.postgres.metadata.view.ViewsMetadata;
import ru.sber.df.epmp.netty_postgres.server.postgres.sql.tree.QualifiedName;
//import com.example.spring.netty.spring_netty.server.postgres.user.Privilege;
//import com.example.spring.netty.spring_netty.server.postgres.user.User;
...
//@Singleton
public class Schemas //extends AbstractLifecycleComponent
        implements Iterable<SchemaInfo>//, ClusterStateListener
{
...
/*
    private Map<String, SchemaInfo> builtInSchemas;
