...
//import com.example.spring.netty.spring_netty.server.postgres.expression.symbol.Symbols;
...
import static ru.sber.df.epmp.netty_postgres.server.postgres.sql.tree.FrameBound.Type.CURRENT_ROW;
import static ru.sber.df.epmp.netty_postgres.server.postgres.sql.tree.FrameBound.Type.UNBOUNDED_PRECEDING;
import static ru.sber.df.epmp.netty_postgres.server.postgres.sql.tree.WindowFrame.Mode.RANGE;
