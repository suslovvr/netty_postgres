...
//import ru.sber.df.epmp.netty_postgres.server.postgres.Streamer;
import ru.sber.df.epmp.netty_postgres.server.postgres.exceptions.ConversionException;
//import ru.sber.df.epmp.netty_postgres.server.postgres.execution.dml.ObjectIndexer;
...
import static ru.sber.df.epmp.netty_postgres.server.postgres.types.DataTypes.ALLOWED_CONVERSIONS;
import static ru.sber.df.epmp.netty_postgres.server.postgres.types.DataTypes.UNDEFINED;
...
*/
    ...
    public static ObjectType merge(ObjectType left, ObjectType right) {
        Builder mergedObjectBuilder = ObjectType.builder();
