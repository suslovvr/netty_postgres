...
//import com.example.spring.netty.spring_netty.server.postgres.expression.symbol.Function;
...
/*
import com.example.spring.netty.spring_netty.server.postgres.lucene.FunctionToQuery;
 ...
 * <p>
 * Argument types and return types are restricted to the types supported by Crate (see { io.crate.types.DataType})
 * </p>
 *
 * <p>
 ...
 *     An exception is if { #compile(List, String, UserLookup)} returns a NEW instance.
 * </p>
 *
 * To implement scalar functions, you may want to use one of the following abstractions:
 *
 * <ul>
 *     <li>{ io.crate.expression.scalar.UnaryScalar}</li>
 *     <li>{ io.crate.expression.scalar.arithmetic.BinaryScalar}</li>
 *     <li>{ io.crate.expression.scalar.DoubleScalar}</li>
 *     <li>{ io.crate.expression.scalar.TripleScalar}</li>
 * </ul>
 *
...
*/
     ...
     *                  { #evaluate(TransactionContext, NodeContext, Input[])} will have the same
