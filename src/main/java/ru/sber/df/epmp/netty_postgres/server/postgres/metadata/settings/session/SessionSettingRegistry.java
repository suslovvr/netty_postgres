...
package ru.sber.df.epmp.netty_postgres.server.postgres.metadata.settings.session;
...
import ru.sber.df.epmp.netty_postgres.server.postgres.types.BooleanType;
...
*/
    private Map<String, SessionSetting<?>> settings = MapBuilder.<String, SessionSetting<?>>treeMapBuilder().map();
