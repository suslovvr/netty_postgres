...
import ru.sber.df.epmp.netty_postgres.server.postgres.protocols.postgres.ConnectionProperties;
...
//-----------------------------
    private static AlwaysOKAuthentication instance=null;
    public synchronized static AlwaysOKAuthentication getInstance() {
        if(instance == null){
            instance = new AlwaysOKAuthentication(UserLookupService.getInstance());
        }
        return instance;
    }
//------------------------------
