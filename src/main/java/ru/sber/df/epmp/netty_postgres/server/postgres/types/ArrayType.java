...
/*
import ru.sber.df.epmp.netty_postgres.server.postgres.exceptions.ConversionException;
import ru.sber.df.epmp.netty_postgres.server.postgres.execution.dml.ArrayIndexer;
import ru.sber.df.epmp.netty_postgres.server.postgres.execution.dml.ValueIndexer;
...
import ru.sber.df.epmp.netty_postgres.server.postgres.metadata.Reference;
import ru.sber.df.epmp.netty_postgres.server.postgres.metadata.RelationName;
import ru.sber.df.epmp.netty_postgres.server.postgres.metadata.settings.SessionSettings;
import ru.sber.df.epmp.netty_postgres.server.postgres.protocols.postgres.parser.PgArrayParser;
import ru.sber.df.epmp.netty_postgres.server.postgres.protocols.postgres.parser.PgArrayParsingException;

 */
import ru.sber.df.epmp.netty_postgres.server.postgres.sql.tree.*;
/*
 ...
 */
    ...
    /**
     * Defaults to the  ArrayStreamer but subclasses may override this method.
     *
    @Override
...
*/
    ...
    public List<T> sanitizeValue(Object value) {
        ...
        convertObjectArray((Object[]) value, innerType::sanitizeValue);
    }
