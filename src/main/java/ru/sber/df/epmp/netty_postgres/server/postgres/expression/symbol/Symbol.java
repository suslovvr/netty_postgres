...
import ru.sber.df.epmp.netty_postgres.server.postgres.expression.scalar.cast.CastMode;
//import com.example.spring.netty.spring_netty.server.postgres.expression.scalar.cast.TryCastFunction;
import ru.sber.df.epmp.netty_postgres.server.postgres.expression.symbol.format.Style;
//import com.example.spring.netty.spring_netty.server.postgres.metadata.functions.Signature;
//import com.example.spring.netty.spring_netty.server.postgres.metadata.functions.TypeVariableConstraint;
...
*/
     ...
     * @return An instance of { Function} which casts this symbol.
     */
    default Symbol cast(DataType<?> targetType, CastMode... modes) {
        ...
        return null;//generateCastFunction(this, targetType, modes);
    }
