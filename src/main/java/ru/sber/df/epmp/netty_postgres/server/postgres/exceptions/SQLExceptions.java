...
//import com.example.spring.netty.spring_netty.server.postgres.metadata.PartitionName;
...
//        throwable instanceof NotSerializableExceptionWrapper ||
    ...
    public static String messageOf(@Nullable Throwable t) {
        ...
        if (unwrappedT.getMessage() == null) {
            if (unwrappedT instanceof DatagateException && unwrappedT.getCause() != null) {
...
*/
    ...
    public static boolean maybeTemporary(Throwable t) {
        return t instanceof ConflictException
//                t instanceof NodeNotConnectedException
