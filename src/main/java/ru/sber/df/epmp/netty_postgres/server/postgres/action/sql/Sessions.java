...
//import com.example.spring.netty.spring_netty.server.postgres.analyze.Analyzer;
...
//import com.example.spring.netty.spring_netty.server.postgres.execution.engine.collect.stats.JobsLogs;
//import com.example.spring.netty.spring_netty.server.postgres.execution.jobs.transport.CancelRequest;
//import com.example.spring.netty.spring_netty.server.postgres.execution.jobs.transport.TransportCancelAction;
...
//import com.example.spring.netty.spring_netty.server.postgres.planner.DependencyCarrier;
//import com.example.spring.netty.spring_netty.server.postgres.planner.Planner;
import ru.sber.df.epmp.netty_postgres.server.postgres.protocols.postgres.KeyData;
...
//        this.clusterService = clusterService;
        ...
        this.isReadOnly = false;//NODE_READ_ONLY_SETTING.get(settings);
...
//            executorProvider.get(),
     ...
     * { io.crate.cluster.gracefulstop.DecommissioningService} must call this while before starting to decommission.
     */
    public void disable() {
        disabled = true;
    }
     ...
     * { io.crate.cluster.gracefulstop.DecommissioningService} must call this when decommissioning is aborted.
     */
    public void enable() {
        disabled = false;
    }
