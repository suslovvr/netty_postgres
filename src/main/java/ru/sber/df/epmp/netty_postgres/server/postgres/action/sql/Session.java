...
package ru.sber.df.epmp.netty_postgres.server.postgres.action.sql;

import ru.sber.df.epmp.netty_postgres.server.postgres.analyze.*;
import ru.sber.df.epmp.netty_postgres.server.postgres.analyze.AnalyzedStatement;
...
import ru.sber.df.epmp.netty_postgres.server.postgres.data.RowConsumer;
//import ru.sber.df.epmp.netty_postgres.server.postgres.execution.engine.collect.stats.JobsLogs;
//import ru.sber.df.epmp.netty_postgres.server.postgres.execution.jobs.kill.KillJobsNodeAction;
//import ru.sber.df.epmp.netty_postgres.server.postgres.execution.jobs.kill.KillJobsNodeRequest;
import ru.sber.df.epmp.netty_postgres.server.postgres.expression.symbol.Symbol;
import ru.sber.df.epmp.netty_postgres.server.postgres.expression.symbol.Symbols;
//import ru.sber.df.epmp.netty_postgres.server.postgres.metadata.CoordinatorTxnCtx;
//import ru.sber.df.epmp.netty_postgres.server.postgres.metadata.NodeContext;
import ru.sber.df.epmp.netty_postgres.server.postgres.metadata.RelationInfo;
//import ru.sber.df.epmp.netty_postgres.server.postgres.metadata.RoutingProvider;
import ru.sber.df.epmp.netty_postgres.server.postgres.metadata.settings.CoordinatorSessionSettings;
/*
import ru.sber.df.epmp.netty_postgres.server.postgres.planner.DependencyCarrier;
import ru.sber.df.epmp.netty_postgres.server.postgres.planner.Plan;
import ru.sber.df.epmp.netty_postgres.server.postgres.planner.Planner;
import ru.sber.df.epmp.netty_postgres.server.postgres.planner.PlannerContext;
import ru.sber.df.epmp.netty_postgres.server.postgres.planner.operators.StatementClassifier;
import ru.sber.df.epmp.netty_postgres.server.postgres.planner.operators.SubQueryResults;
import ru.sber.df.epmp.netty_postgres.server.postgres.planner.optimizer.costs.PlanStats;
 */
import ru.sber.df.epmp.netty_postgres.server.postgres.protocols.postgres.*;
/*
import ru.sber.df.epmp.netty_postgres.server.postgres.sql.SqlFormatter;
import ru.sber.df.epmp.netty_postgres.server.postgres.sql.parser.SqlParser;
import ru.sber.df.epmp.netty_postgres.server.postgres.sql.tree.Declare;
import ru.sber.df.epmp.netty_postgres.server.postgres.sql.tree.Declare.Hold;
import ru.sber.df.epmp.netty_postgres.server.postgres.sql.tree.DiscardStatement.Target;
 */
import ru.sber.df.epmp.netty_postgres.server.postgres.protocols.postgres.FormatCodes;
import ru.sber.df.epmp.netty_postgres.server.postgres.protocols.postgres.Portal;
import ru.sber.df.epmp.netty_postgres.server.postgres.protocols.postgres.TransactionState;
 ...
 */
    ...
    public boolean hasDeferredExecutions() {
        return false;// !deferredExecutionsByStmt.isEmpty();
    }
